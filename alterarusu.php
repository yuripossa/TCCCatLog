		...
		<div>
			<form class='form-usuario' name="form1" method="post" action="alterarusu1.php">
				...
				<?php
						...
						echo"
							<div class='form-row'>
	                			<div class='col-md-12 mb-1'>
	                    			...
	                    			<input class='form-control' type='text' name='nomeusu' value='$con[nomeusu]' size='20' maxlength='20' required placeholder='Digite seu nome de Usuário...'/>
	                			</div>
								<div class='col-md-12 mb-1'>
		                    		<label class='sr-only'>Senha:</label>
		                    		<input class='form-control' type='text' name='senha' value='$con[senha]' size='20' required maxlength='20' placeholder='Máximo de 20 caractéres...'>
		                		</div>
								<div class='col-md-12 mb-1'>
					...
					?>
				<button class="col-md-12 mb-1 btn btn-lg btn-primary btn-block busuario" type="submit" value='alterar'>Alterar</button>
			</form>
			<form class='form-usuario' name="form1" method="post" action="deletausu.php">
				<?PHP echo("<input type='hidden' name='cod' value='$con[ID]'>");?>
			 	<button class="col-md-12 mb-1 btn btn-lg btn-primary btn-block busuario" type="submit" value='deletar'>Deletar</button>
			</form>
			<div class='form-usuario'>
				<button class="col-md-12 btn btn-lg btn-primary btn-block busuario" onclick="document.location.href='perfil.html'" type="submit" value='voltar'>Voltar</button>
			</div>
